...
CREATE TABLE `permissions` (
  ...
  `manage_permission` tinyint(1) DEFAULT '0',
  `view_permission` tinyint(1) DEFAULT '0',
  `manage_users` tinyint(1) DEFAULT '0',
  `view_users` tinyint(1) DEFAULT '0',
  `view_leader_material` tinyint(1) DEFAULT '0',
  `view_senior_delegate_material` tinyint(1) DEFAULT '0',
  `manage_result` tinyint(1) DEFAULT '0',
  `manage_finances` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `index_permissions_on_entity_type_and_entity_id` (`entity_type`,`entity_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `teams` (
  ...
  `permissions_type` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `permissions_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `index_teams_on_friendly_id` (`friendly_id`),
  KEY `index_teams_on_permissions_type_and_permissions_id` (`permissions_type`,`permissions_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  KEY `index_users_on_permissions_type_and_permissions_id` (`permissions_type`,`permissions_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
